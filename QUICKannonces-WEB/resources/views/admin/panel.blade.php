<div style="border: 1px solid #052c65;" class="mb-3">
  ...
  <a href="{{ route('annonce.pendingAnnonce') }}">
    <div class="d-flex justify-content-center align-items-center bg-light p-2" style="gap: 20px">
      <div class="border d-flex flex-column justify-content-between align-items-center" style="width: 190px; height: 150px; background-color: #fff; border-radius: 10px; padding: 15px 0px">
  ...
  <a href="{{ route('ville.index') }}">
    <div class="border" style="width: 190px; height: 150px; background-color: #fff; border-radius: 10px">
      <div class="border d-flex flex-column justify-content-between align-items-center" style="width: 190px; height: 150px; background-color: #fff; border-radius: 10px; padding: 15px 0px">
  ...
  <a href="{{ route('annonce.all') }}">
    <div class="border" style="width: 190px; height: 150px; background-color: #fff; border-radius: 10px">
      <div class="border d-flex flex-column justify-content-between align-items-center" style="width: 190px; height: 150px; background-color: #fff; border-radius: 10px; padding: 15px 0px">
        <div>@include('icons.supprimer une annonce-01')</div>
